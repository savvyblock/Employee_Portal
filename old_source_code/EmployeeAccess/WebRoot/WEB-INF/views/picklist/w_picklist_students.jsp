...
<div id="directory" class="fill_section picklist_box" style="width: 800px; height: 410px;">
		...
		<div style="margin-top: 5px;">
			<table>
				<tr>
					...
					<td style="padding-right: 8px;">
						<input type="text" class="text focusable wrap_field initial_focus is_filter"
							   focus-class="focus_text"
							   value="" 
					...
					<td>
						<select class="is_filter" id="active_code" tabindex="1">
							...
							<table id="picklistTable" class="tabular selectable_table ${selectionType}" style="overflow: auto; height: auto; width: 740px">
								<thead id="picklistThead">
									<tr>
										...
										<th style="text-align: center;">
											<span id="studentId" class="picklist_data">Student ID</span>
										</th>
										<th style="text-align: center">
										...
										<th style="text-align: center;">
											<span id="activeCd" class="picklist_data">Status</span>
										</th>
										<th style="text-align: center;">
											<span id="stateId" class="picklist_data">State Stu Id</span>
										</th>
									</tr>
								</thead>
