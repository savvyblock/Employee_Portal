...
public class Earnings implements Serializable
{
	...
	private List <EarningsNonTrsTax> nonTrsTax;
	private List<EarningsNonTrsNonTax> nonTrsNonTax;
	...
	public List<EarningsNonTrsTax> getNonTrsTax() {
		return nonTrsTax;
	}
	public void setNonTrsTax(List<EarningsNonTrsTax> nonTrsTax) {
		this.nonTrsTax = nonTrsTax;
	}
	
	public List<EarningsNonTrsNonTax> getNonTrsNonTax() {
		return nonTrsNonTax;
	}
	public void setNonTrsNonTax(List<EarningsNonTrsNonTax> nonTrsNonTax) {
