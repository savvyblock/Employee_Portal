...
public class SupervisorController {
    ...
    public ModelAndView nextLevelFromApproveLeave(HttpServletRequest req, String level, String chain, String selectEmpNbr) throws ParseException{
		...
		if (selectEmpNbr!=null && 
				selectEmpNbr.trim().length()>0 && 
    ...
    public ModelAndView previousLevelFromApproveLeave(HttpServletRequest req, String level, String chain) throws ParseException{
        HttpSession session = req.getSession();
        BeaUsers user = (BeaUsers)session.getAttribute("user");
        ModelAndView mav = new ModelAndView();
        if(null == user){
    ...
    public ModelAndView approveLeave(HttpServletRequest req, String level, String chain, String id, String comment) throws ParseException{
        HttpSession session = req.getSession();
        BeaUsers user = (BeaUsers)session.getAttribute("user");
        ModelAndView mav = new ModelAndView();
        if(null == user){
    ...
    public ModelAndView disapproveLeave(HttpServletRequest req, String level, String chain, String id, String comment) throws ParseException{
        HttpSession session = req.getSession();
        BeaUsers user = (BeaUsers)session.getAttribute("user");
        ModelAndView mav = new ModelAndView();
        if(null == user){
    ...
    public ModelAndView getApproveLeaveRequestList(HttpServletRequest req, String empNbr) throws ParseException{
		...
		List<LeaveEmployeeData> employeeData = this.supService.getDirectReportEmployee(empNbr,params.isUsePMIS(),supervisorsOnly,excludeTempApprovers);
        ...
        List<AppLeaveRequest> leavesCalendar = this.supService.getLeaveDetailsForCalendar(demo.getEmpNbr(),null,null,null);
        List<LeaveRequestModel> requestModels = new ArrayList<LeaveRequestModel>();
        LeaveRequestModel model;
        ...
        for(int i=0;i<requestModels.size();i++) {
        	calendar.add(requestModels.get(i).toJSON(leaveStatus));
        }
    ...
    public ModelAndView getLeaveOverviewList(HttpServletRequest req,String empNbr, String chain, String freq, String startDate, String endDate, Boolean isChangeLevel) throws ParseException{
        HttpSession session = req.getSession();
        BeaUsers user = (BeaUsers)session.getAttribute("user");
        ModelAndView mav = new ModelAndView();
        if(null == user){
		...
		if((isChangeLevel!=null && isChangeLevel) || (root.getEmpNbr().equals(empNbr))) {
			...
			List<LeaveEmployeeData> employeeData = this.supService.getDirectReportEmployee(supervisor,params.isUsePMIS(),supervisorsOnly,excludeTempApprovers);
			LeaveEmployeeData empty =  new LeaveEmployeeData();
			List<LeaveEmployeeData> directReport = new ArrayList<LeaveEmployeeData>();
			directReport.add(empty);
			directReport.addAll(employeeData);
        ...
        List<AppLeaveRequest> leavesCalendar = this.supService.getLeaveDetailsForCalendar(demo.getEmpNbr(),freq,start,end);
        ...
        for(int i=0;i<requestModels.size();i++) {
        	...
        	if(requestModels.get(i).getEmpNbr().equals(demo.getEmpNbr()))
        		employee.add(requestModels.get(i).toJSON(leaveStatus));
        }
		List<Code> absRsns = this.referenceService.getAbsRsns();
		JSONArray absRsnsJson = new JSONArray();
        for(int i=0;i<absRsns.size();i++) {
     ...
     public ModelAndView nextLevelFromLeaveOverview(HttpServletRequest req, String level, String chain, String selectEmpNbr) throws ParseException{
         HttpSession session = req.getSession();
         BeaUsers user = (BeaUsers)session.getAttribute("user");
         ModelAndView mav = new ModelAndView();
         if(null == user){
     ...
     public ModelAndView previousLevelFromLeaveOverview(HttpServletRequest req, String level, String chain) throws ParseException{
         HttpSession session = req.getSession();
         BeaUsers user = (BeaUsers)session.getAttribute("user");
         ModelAndView mav = new ModelAndView();
         if(null == user){
     ...
     public ModelAndView updateLeaveFromLeaveOverview(HttpServletRequest req, String level, String chain,
    		 String leaveId, String leaveType, String absenseReason, String LeaveStartDate, String startTimeValue,
 			String LeaveEndDate, String endTimeValue, String lvUnitsDaily, String lvUnitsUsed, String Remarks, String empNbr,
 			String freq, String startDate, String endDate) throws ParseException{
         HttpSession session = req.getSession();
         BeaUsers user = (BeaUsers)session.getAttribute("user");
         ModelAndView mav = new ModelAndView();
         if(null == user){
    ...
    public ModelAndView nextLevelFromTempApprovers(HttpServletRequest req, String level, String chain, String selectEmpNbr) throws ParseException{
        HttpSession session = req.getSession();
        BeaUsers user = (BeaUsers)session.getAttribute("user");
        ModelAndView mav = new ModelAndView();
        if(null == user){
    ...
    public ModelAndView previousLevelFromTempApprovers(HttpServletRequest req, String level, String chain) throws ParseException{
        HttpSession session = req.getSession();
        BeaUsers user = (BeaUsers)session.getAttribute("user");
        ModelAndView mav = new ModelAndView();
        if(null == user){
    ...
    public ModelAndView saveTempApprovers(HttpServletRequest req, String level, String chain, String empNbr, String approverJson) throws ParseException{
        HttpSession session = req.getSession();
        BeaUsers user = (BeaUsers)session.getAttribute("user");
        ModelAndView mav = new ModelAndView();
        if(null == user){
