...
/**
 * BhrEmpDeductId generated by hbm2java
 */
@Embeddable
public class BhrEmpDeductId implements java.io.Serializable {
	...
	public BhrEmpDeductId() {
	}

	public BhrEmpDeductId(char payFreq, String empNbr, String dedCd, char dedSeq, char cyrNyrFlg) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrEmpDeductId))
			return false;
		BhrEmpDeductId castOther = (BhrEmpDeductId) other;
