...
/**
 * BhrTeamEd90Id generated by hbm2java
 */
@Embeddable
public class BhrTeamEd90Id implements java.io.Serializable {

	private String rptYr;
	private String rptMon;
	private String empNbr;

	public BhrTeamEd90Id() {
	}

	public BhrTeamEd90Id(String rptYr, String rptMon, String empNbr) {
		this.rptYr = rptYr;
		this.rptMon = rptMon;
		this.empNbr = empNbr;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrTeamEd90Id))
			return false;
		BhrTeamEd90Id castOther = (BhrTeamEd90Id) other;
