...
/**
 * BhrTeamEr20Id generated by hbm2java
 */
@Embeddable
public class BhrTeamEr20Id implements java.io.Serializable {

	private String rptYr;
	private String rptMon;
	private String empNbr;

	public BhrTeamEr20Id() {
	}

	public BhrTeamEr20Id(String rptYr, String rptMon, String empNbr) {
		this.rptYr = rptYr;
		this.rptMon = rptMon;
		this.empNbr = empNbr;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrTeamEr20Id))
			return false;
		BhrTeamEr20Id castOther = (BhrTeamEr20Id) other;
