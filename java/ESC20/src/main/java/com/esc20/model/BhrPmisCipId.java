...
/**
 * BhrPmisCipId generated by hbm2java
 */
@Embeddable
public class BhrPmisCipId implements java.io.Serializable {
	...
	public BhrPmisCipId(char cyrNyrFlg, char payFreq, String empNbr, String dtEff, String dtsCipTrans, String jobCd,
			String extraDutyCd, String posNbr, String billetNbr, char posTyp) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrPmisCipId))
			return false;
		BhrPmisCipId castOther = (BhrPmisCipId) other;
