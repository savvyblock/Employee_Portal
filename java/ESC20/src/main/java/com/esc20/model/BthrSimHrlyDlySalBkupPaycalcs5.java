...
/**
 * BthrSimHrlyDlySalBkupPaycalcs5 generated by hbm2java
 */
@Entity
@Table(name = "BTHR_SIM_HRLY_DLY_SAL_BKUP_PAYCALCS_5", schema = "rsccc", catalog = "rsccc")
public class BthrSimHrlyDlySalBkupPaycalcs5 implements java.io.Serializable {

	private BthrSimHrlyDlySalBkupPaycalcs5Id id;

	public BthrSimHrlyDlySalBkupPaycalcs5() {
	}

	public BthrSimHrlyDlySalBkupPaycalcs5(BthrSimHrlyDlySalBkupPaycalcs5Id id) {
		this.id = id;
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "amtChg", column = @Column(name = "AMT_CHG", nullable = false, precision = 6, scale = 3)),
	...
	public BthrSimHrlyDlySalBkupPaycalcs5Id getId() {
		return this.id;
	}

	public void setId(BthrSimHrlyDlySalBkupPaycalcs5Id id) {
		this.id = id;
	}
