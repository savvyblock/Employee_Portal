...
/**
 * BthrSimHrlyDlySalBkupPaycalcs5Id generated by hbm2java
 */
@Embeddable
public class BthrSimHrlyDlySalBkupPaycalcs5Id implements java.io.Serializable {
	...
	public BthrSimHrlyDlySalBkupPaycalcs5Id() {
	}

	public BthrSimHrlyDlySalBkupPaycalcs5Id(char cyrNyrFlg, String simName, String payGrd, String payStp, char sched,
			BigDecimal amtChg, BigDecimal pctChg, String module) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BthrSimHrlyDlySalBkupPaycalcs5Id))
			return false;
		BthrSimHrlyDlySalBkupPaycalcs5Id castOther = (BthrSimHrlyDlySalBkupPaycalcs5Id) other;
