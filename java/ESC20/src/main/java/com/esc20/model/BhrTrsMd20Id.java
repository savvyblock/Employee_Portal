...
/**
 * BhrTrsMd20Id generated by hbm2java
 */
@Embeddable
public class BhrTrsMd20Id implements java.io.Serializable {
	...
	public BhrTrsMd20Id(String rptMon, String rptYr, String staffId) {
		this.rptMon = rptMon;
		this.rptYr = rptYr;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrTrsMd20Id))
			return false;
		BhrTrsMd20Id castOther = (BhrTrsMd20Id) other;
