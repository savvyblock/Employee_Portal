...
/**
 * BhrAca1095cCovrd generated by hbm2java
 */
@Entity
@Table(name = "BHR_ACA_1095C_COVRD", schema = "rsccc", catalog = "rsccc")
public class BhrAca1095cCovrd implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7187894354400224955L;
	private BhrAca1095cCovrdId id;
	...
	public BhrAca1095cCovrd() {
	}

	public BhrAca1095cCovrd(BhrAca1095cCovrdId id, String nameF, String nameM, String nameL, char nameGen, String ssn,
			String dob, char monAll, char mon01, char mon02, char mon03, char mon04, char mon05, char mon06, char mon07,
			char mon08, char mon09, char mon10, char mon11, char mon12, String module, char empFlg) {
		this.id = id;
		this.nameF = nameF;
		this.nameM = nameM;
		this.nameL = nameL;
	...
	public BhrAca1095cCovrdId getId() {
		return this.id;
	}

	public void setId(BhrAca1095cCovrdId id) {
		this.id = id;
	}
