...
/**
 * BhrCalYtdId generated by hbm2java
 */
@Embeddable
public class BhrCalYtdId implements java.io.Serializable {
	...
	public BhrCalYtdId(char payFreq, String empNbr, char cyrNyrFlg, String calYr) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrCalYtdId))
			return false;
		BhrCalYtdId castOther = (BhrCalYtdId) other;
