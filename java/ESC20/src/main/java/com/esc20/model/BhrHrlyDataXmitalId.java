...
/**
 * BhrHrlyDataXmitalId generated by hbm2java
 */
@Embeddable
public class BhrHrlyDataXmitalId implements java.io.Serializable {
	...
	public BhrHrlyDataXmitalId() {
	}

	public BhrHrlyDataXmitalId(char payFreq, String empNbr, char cyrNyrFlg, String dtOfPay, String dts, String seqNbr) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrHrlyDataXmitalId))
			return false;
		BhrHrlyDataXmitalId castOther = (BhrHrlyDataXmitalId) other;
