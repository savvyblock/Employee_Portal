...
/**
 * BhrAca1095cEmpHistId generated by hbm2java
 */
@Embeddable
public class BhrAca1095cEmpHistId implements java.io.Serializable {
	private static final long serialVersionUID = 6715142900654758429L;
	private String empNbr;
	private String calYr;
	private String calMon;

	public BhrAca1095cEmpHistId() {
	}

	public BhrAca1095cEmpHistId(String empNbr, String calYr, String calMon) {
		this.empNbr = empNbr;
		this.calYr = calYr;
		this.calMon = calMon;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrAca1095cEmpHistId))
			return false;
		BhrAca1095cEmpHistId castOther = (BhrAca1095cEmpHistId) other;
