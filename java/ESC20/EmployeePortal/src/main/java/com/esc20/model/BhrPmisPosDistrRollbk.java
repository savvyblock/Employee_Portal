...
/**
 * BhrPmisPosDistrRollbk generated by hbm2java
 */
@Entity
@Table(name = "BHR_PMIS_POS_DISTR_ROLLBK", schema = "rsccc", catalog = "rsccc")
public class BhrPmisPosDistrRollbk implements java.io.Serializable {
	private static final long serialVersionUID = 6715142900654758429L;
	private BhrPmisPosDistrRollbkId id;
	...
	public BhrPmisPosDistrRollbk() {
	}

	public BhrPmisPosDistrRollbk(BhrPmisPosDistrRollbkId id, String jobCd, char acctTyp, String payActy, char wrkComp,
			...
			char expense373, char contribAcctFlg) {
		this.id = id;
		this.jobCd = jobCd;
	...
	public BhrPmisPosDistrRollbkId getId() {
		return this.id;
	}

	public void setId(BhrPmisPosDistrRollbkId id) {
		this.id = id;
	}
