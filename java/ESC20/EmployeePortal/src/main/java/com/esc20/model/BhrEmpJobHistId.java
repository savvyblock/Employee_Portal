...
/**
 * BhrEmpJobHistId generated by hbm2java
 */
@Embeddable
public class BhrEmpJobHistId implements java.io.Serializable {
	...
	public BhrEmpJobHistId() {
	}

	public BhrEmpJobHistId(char payFreq, String empNbr, char cyrNyrFlg, String jobCd, String dtOfPay, String chkNbr,
			char voidOrIss, short adjNbr) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrEmpJobHistId))
			return false;
		BhrEmpJobHistId castOther = (BhrEmpJobHistId) other;
