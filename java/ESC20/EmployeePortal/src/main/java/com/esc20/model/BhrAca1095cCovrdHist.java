...
public class BhrAca1095cCovrdHist implements java.io.Serializable {
	...
	private transient String ssnString;
	
	public BhrAca1095cCovrdHist() {
	}

	public BhrAca1095cCovrdHist(BhrAca1095cCovrdHistId id, String nameF, String nameM, String nameL, Character nameGen,
			...
			Character mon07, Character mon08, Character mon09, Character mon10, Character mon11, Character mon12, Character empFlg) {
		this.id = id;
		this.nameF = nameF;
		this.nameM = nameM;
		this.nameL = nameL;
