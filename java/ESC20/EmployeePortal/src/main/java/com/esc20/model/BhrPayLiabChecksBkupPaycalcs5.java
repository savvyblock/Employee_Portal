...
/**
 * BhrPayLiabChecksBkupPaycalcs5 generated by hbm2java
 */
@Entity
@Table(name = "BHR_PAY_LIAB_CHECKS_BKUP_PAYCALCS_5", schema = "rsccc", catalog = "rsccc")
public class BhrPayLiabChecksBkupPaycalcs5 implements java.io.Serializable {
	private static final long serialVersionUID = 6715142900654758429L;
	private BhrPayLiabChecksBkupPaycalcs5Id id;

	public BhrPayLiabChecksBkupPaycalcs5() {
	}

	public BhrPayLiabChecksBkupPaycalcs5(BhrPayLiabChecksBkupPaycalcs5Id id) {
		this.id = id;
	}
	...
	public BhrPayLiabChecksBkupPaycalcs5Id getId() {
		return this.id;
	}

	public void setId(BhrPayLiabChecksBkupPaycalcs5Id id) {
		this.id = id;
	}
