...
/**
 * BhrPmisPosCtrlRollbk generated by hbm2java
 */
@Entity
@Table(name = "BHR_PMIS_POS_CTRL_ROLLBK", schema = "rsccc", catalog = "rsccc")
public class BhrPmisPosCtrlRollbk implements java.io.Serializable {
	private static final long serialVersionUID = 6715142900654758429L;
	private BhrPmisPosCtrlRollbkId id;
	...
	public BhrPmisPosCtrlRollbk() {
	}

	public BhrPmisPosCtrlRollbk(BhrPmisPosCtrlRollbkId id, String posDescr, char posStat, String posSchYr, char primJob,
			char incrElig, String occPayGrd, String occPayStp, char occPaySched, String stStp, String contrDtBeg,
			String contrDtEnd, String dtPayoff, BigDecimal nbrDaysOff, BigDecimal actHrlyDlyRate, BigDecimal salAmt,
			short nbrRemainPymts, String jobCateg, char supplAtch, String jobCd, String frstPaydtCd, String calCd,
			String campusId, char dept, BigDecimal hrsPerDay, BigDecimal dayEmpldPct, BigDecimal pctOfYr,
			char payConcpt, String eeocCd, char wrkComp, String trsPosCd, BigDecimal maxDays, short maxPymts,
			char ovtmEligFlg, short stMinDays, String spvsrPosNbr, String spvsrBilletNbr, BigDecimal supplExtraDays,
			String supplToPosNbr, String supplToPosBillet, String extraDutyCd, char supplTyp, BigDecimal supplMaxAmt,
			char basSupplOnDlyRate, char supplPay1time, String dtSuppl1time, char acptChg, String dtCreateUpdt,
			String dtFill, String fillPosRsn, String dtCriteria, String dtAuth, String dtAuthEnd, String dtEntry,
			String dtInactv, String inactvRsnCd, String vacRsn, String payGrd, String payStp, char paySched,
			BigDecimal equivUnts, char midpntBas, BigDecimal pctOfMidpnt, char unempEligFlg, char ficaElig,
			char trsStatCd, BigDecimal budAmt, char budSalOvrrid, char actBudInd, char payTyp, char occPayTyp,
			BigDecimal nbrDaysEmpld, char supplRecalc, char ignPctDayForSalCalcs, char ignPctYrForSalCalcs) {
		this.id = id;
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "befOrAft", column = @Column(name = "BEF_OR_AFT", nullable = false, length = 1)),
			@AttributeOverride(name = "payFreq", column = @Column(name = "PAY_FREQ", nullable = false, length = 1)),
			@AttributeOverride(name = "occEmpNbr", column = @Column(name = "OCC_EMP_NBR", nullable = false, length = 6)),
	...
	public BhrPmisPosCtrlRollbkId getId() {
		return this.id;
	}

	public void setId(BhrPmisPosCtrlRollbkId id) {
		this.id = id;
	}
