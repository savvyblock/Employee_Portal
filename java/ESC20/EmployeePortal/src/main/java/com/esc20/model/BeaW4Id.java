...
/**
 * BeaW4Id generated by hbm2java
 */
@Embeddable
public class BeaW4Id implements java.io.Serializable {
	...
	public BeaW4Id(Character payFreq, String empNbr, String reqDts) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BeaW4Id))
			return false;
		BeaW4Id castOther = (BeaW4Id) other;
