...
public class EA1095CInfoCommand {

	// Elements of BHR_ACA_1095C_EMP table 
	private String cyrNyrFlg = "";
	private String empNbr = "";
	private String calYr = "";
	private String calMon = "";
	private String offrOfCovrg = "";
	private BigDecimal empShr = BigDecimal.ZERO.setScale(2, BigDecimal.ROUND_HALF_UP);
	private String safeHrbr = "";
	private boolean selfIns = false;
	private String planStrtMon = "";

	private Map<String, EA1095CInfoCommand> acaYTD1095CEmpDataMap = new HashMap<String, EA1095CInfoCommand>();

	// Elements of BHR_ACA_1095C_COVRD Table
	...
	private boolean hasEmpDataChanged = false;
	private boolean hasCovrgDataChanged = false;

	// Elements for Pagination
	protected Integer currentPage = 1;
	protected Integer totalPages = null;
	protected Integer selectedPage = null;
	protected Integer pageSize = 23;
	...
	public Map<String, EA1095CInfoCommand> getAcaYTD1095CEmpDataMap() {
		return acaYTD1095CEmpDataMap;
	}

	public void setAcaYTD1095CEmpDataMap(Map<String, EA1095CInfoCommand> acaYTD1095CEmpDataMap) {
		this.acaYTD1095CEmpDataMap = acaYTD1095CEmpDataMap;
	}
	...
	public boolean isHasEmpDataChanged() {
		return hasEmpDataChanged;
	}

	public void setHasEmpDataChanged(boolean hasEmpDataChanged) {
		this.hasEmpDataChanged = hasEmpDataChanged;
	}

	public boolean isHasCovrgDataChanged() {
		return hasCovrgDataChanged;
	}

	public void setHasCovrgDataChanged(boolean hasCovrgDataChanged) {
		this.hasCovrgDataChanged = hasCovrgDataChanged;
	}
