...
/**
 * BhrAca1095cCovrdHistId generated by hbm2java
 */
@Embeddable
public class BhrAca1095cCovrdHistId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 964756328933223460L;
	private String empNbr;
	private String calYr;
	private byte seqNbr;

	public BhrAca1095cCovrdHistId() {
	}

	public BhrAca1095cCovrdHistId(String empNbr, String calYr, byte seqNbr) {
		this.empNbr = empNbr;
		this.calYr = calYr;
		this.seqNbr = seqNbr;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrAca1095cCovrdHistId))
			return false;
		BhrAca1095cCovrdHistId castOther = (BhrAca1095cCovrdHistId) other;
