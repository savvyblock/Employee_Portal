...
/**
 * BhrAca1095bCovrd generated by hbm2java
 */
@Entity
@Table(name = "BHR_ACA_1095B_COVRD", schema = "rsccc", catalog = "rsccc")
public class BhrAca1095bCovrd implements java.io.Serializable {
	...
	public BhrAca1095bCovrdId getId() {
		return this.id;
	}

	public void setId(BhrAca1095bCovrdId id) {
		this.id = id;
	}
