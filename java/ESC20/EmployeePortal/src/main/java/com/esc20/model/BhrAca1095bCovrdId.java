...
/**
 * BhrAca1095bCovrdId generated by hbm2java
 */
@Embeddable
public class BhrAca1095bCovrdId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5852374267277941534L;
	private String empNbr;
	private String calYr;
	private byte seqNbr;

	public BhrAca1095bCovrdId() {
	}

	public BhrAca1095bCovrdId(String empNbr, String calYr, byte seqNbr) {
		this.empNbr = empNbr;
		this.calYr = calYr;
		this.seqNbr = seqNbr;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrAca1095bCovrdId))
			return false;
		BhrAca1095bCovrdId castOther = (BhrAca1095bCovrdId) other;
