...
/**
 * BhrPmisPosHistDistr generated by hbm2java
 */
@Entity
@Table(name = "BHR_PMIS_POS_HIST_DISTR", schema = "rsccc", catalog = "rsccc")
public class BhrPmisPosHistDistr implements java.io.Serializable {
	private static final long serialVersionUID = 6715142900654758429L;
	private BhrPmisPosHistDistrId id;
	...
	public BhrPmisPosHistDistr() {
	}

	public BhrPmisPosHistDistr(BhrPmisPosHistDistrId id, char payFreq, String jobCd, char acctTyp, String payActy,
			char wrkComp, char glFileId, String fund, String func, String obj, String sobj, String org, char fsclYr,
			String pgm, char edSpan, String projDtl, BigDecimal acctAmt, BigDecimal acctPct, String trsGrantCd,
			String extraDutyCd, char expense373, char contribAcctFlg, String module) {
		this.id = id;
	...
	public BhrPmisPosHistDistrId getId() {
		return this.id;
	}

	public void setId(BhrPmisPosHistDistrId id) {
		this.id = id;
	}
