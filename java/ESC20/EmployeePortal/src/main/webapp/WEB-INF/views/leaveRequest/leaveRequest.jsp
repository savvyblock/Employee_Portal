		...
		<section class="content">
			<div class="clearfix section-title">
				...
				<div class="pull-right right-btn">
					<button class="btn btn-primary"  onclick="showRequestForm()" <c:if test="${!haveSupervisor}">disabled="true"</c:if> id="new-btn" data-toggle="modal" data-target="#requestModal">
