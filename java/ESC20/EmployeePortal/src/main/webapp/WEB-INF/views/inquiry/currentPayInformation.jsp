        ...
        <main class="content-wrapper" id="content" tabindex="-1">
            <section class="content">
                <div class="">
                    ...
                    <div class="toPrint content-white EMP-detail heightFull">
                    ...
                    <c:if test="${not empty sessionScope.options.messageCurrentPayInformation}">
                        <p class="topMsg error-hint" role="alert">${sessionScope.options.messageCurrentPayInformation}
                        </p>
                    </c:if>
                    ...
                    <div class="needToClone">
                        ...
                        <table class="table border-table responsive-table no-thead print-table noNumTable">
                            <tbody>
                                <tr>
                                    <th id="userDetailName" class="td-title">
                                        <b>${sessionScope.languageJSON.currentPayTable.name}</b></th>
                                    <td headers="userDetailName" class="td-content" colspan="3"
                                        data-title="${sessionScope.languageJSON.currentPayTable.name}">
                                        ${sessionScope.userDetail.nameF} ${sessionScope.userDetail.nameM}
                                        ${sessionScope.userDetail.nameL} ${sessionScope.userDetail.genDescription}
                                    </td>
                                </tr>
                                <tr>
                                    <th id="userDetailAddress" class="td-title" rowspan="2">
                                        <b>${sessionScope.languageJSON.currentPayTable.address}</b></th>
                                    <td headers="userDetailAddress" class="td-content"
                                        data-title="${sessionScope.languageJSON.currentPayTable.address}" rowspan="2">
                                        ${sessionScope.userDetail.addrNbr} ${sessionScope.userDetail.addrStr}
                                        ${sessionScope.userDetail.addrApt}<br />
                                        ${sessionScope.userDetail.addrCity},
                                        ${sessionScope.userDetail.addrSt} ${sessionScope.userDetail.addrZip}
                                    </td>
                                    <th id="employeeId" class="td-title">
                                        <b>${sessionScope.languageJSON.currentPayTable.employeeId}</b></th>
                                    <td headers="employeeId" class="td-content"
                                ...
                                <tr>
                                    ...
                                    <td headers="dateOfBirth" class="td-content"
                                ...
                                <tr>
                                    ...
                                    <td headers="phoneNumber" class="td-content"
                                    ...
                                    <th id="gender" class="td-title">
                                        <b>${sessionScope.languageJSON.currentPayTable.gender}</b></th>
                                ...
                                <tr>
                                    <th id="degree" class="td-title">
                                        <b>${sessionScope.languageJSON.currentPayTable.degree}</b></th>
                                    <td headers="degree" class="td-content"
                                        data-title="${sessionScope.languageJSON.currentPayTable.degree}" colspan="3">
                                ...
                                <tr>
                                    ...
                                    <td headers="professionalYearsExp" class="td-content"
                                    ...
                                    <td headers="professionalDistrictExp" class="td-content"
                                ...
                                <tr>
                                    ...
                                    <td headers="nonProfessionalYearExp" class="td-content"
                                    ...
                                    <td headers="noneProfessionalDistrictExp" class="td-content"
                        ...
                        <c:if test="${fn:length(frequencies) > 0}">
                            <c:forEach var="frequency" items="${frequencies}" varStatus="count">
                                ...
                                <table class="table border-table responsive-table no-thead print-table smTitleTable">
                                    <tbody>
                                        <c:forEach var="job" items="${jobs[frequency]}" varStatus="jobCount">
                                            <tr>
                                                <th id="jobCdDescription_${jobCount.index}" class="td-title">
                                                    ${sessionScope.languageJSON.currentPayTable.title}</th>
                                                <td headers="jobCdDescription_${jobCount.index}"
                                                    class="td-content text-left"
                                                    data-title="${sessionScope.languageJSON.currentPayTable.title}">
                                                    <b>
                                                        ${job.jobCdDescription}
                                                    </b>
                                                </td>
                                                <th id="annualPayments_${jobCount.index}" class="td-title">
                                                    ${sessionScope.languageJSON.currentPayTable.annualPayments}</th>
                                                <td headers="annualPayments_${jobCount.index}"
                                                    class="td-content moreBig text-right"
                                                    data-title="${sessionScope.languageJSON.currentPayTable.annualPayments}">
                                                    ${job.nbrAnnualPymts}
                                                </td>
                                                <th id="regularHour_${jobCount.index}" class="td-title">
                                                    ${sessionScope.languageJSON.currentPayTable.regularHour}</th>
                                                <td headers="regularHour_${jobCount.index}"
                                                    class="td-content moreBig text-right"
                                                    data-title="${sessionScope.languageJSON.currentPayTable.regularHour}">
                                                    <fmt:formatNumber value="${job.regHrsWrk}" pattern="#,##0.00" />
                                                </td>
                                                <th id="remailPayments_${jobCount.index}" class="td-title">
                                                    ${sessionScope.languageJSON.currentPayTable.remailPayments}</th>
                                                <td headers="remailPayments_${jobCount.index}"
                                                    class="td-content moreBig text-right"
                                                    data-title="${sessionScope.languageJSON.currentPayTable.remailPayments}">
                                                    ${job.nbrRemainPymts}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th id="annualSalary_${jobCount.index}" class="td-title">
                                                    ${sessionScope.languageJSON.currentPayTable.annualSalary}</th>
                                                <td headers="annualSalary_${jobCount.index}"
                                                    class="td-content text-right"
                                                    data-title="${sessionScope.languageJSON.currentPayTable.annualSalary}">
                                                    <fmt:formatNumber value="${job.contrAmt}" pattern="#,##0.00" />
                                                </td>
                                                <th id="dailyRate_${jobCount.index}" class="td-title">
                                                    ${sessionScope.languageJSON.currentPayTable.dailyRate}</th>
                                                <td headers="dailyRate_${jobCount.index}" class="td-content text-right"
                                                    data-title="${sessionScope.languageJSON.currentPayTable.dailyRate}">
                                                    <fmt:formatNumber value="${job.dlyRateofPay}" pattern="#,##0.000" />
                                                </td>
                                                <th id="payRate_${jobCount.index}" class="td-title">
                                                    ${sessionScope.languageJSON.currentPayTable.payRate}</th>
                                                <td headers="payRate_${jobCount.index}" class="td-content text-right"
                                                    data-title="${sessionScope.languageJSON.currentPayTable.payRate}">
                                                    <fmt:formatNumber value="${job.payRate}" pattern="#,##0.00" />
                                                </td>
                                                <th id="overtimeRate_${jobCount.index}" class="td-title">
                                                    ${sessionScope.languageJSON.currentPayTable.overtimeRate}</th>
                                                <td headers="overtimeRate_${jobCount.index}"
                                                    class="td-content text-right"
                                                    data-title="${sessionScope.languageJSON.currentPayTable.overtimeRate}">
                                ...
                                <c:if test="${fn:length(accounts[frequency]) > 0}">
                                    ...
                                    <table class="table border-table responsive-table print-table bankAccountTable">
                                        <thead>
                                            <tr>
                                                <th id="bankCode">${sessionScope.languageJSON.currentPayTable.bankCode}
                                                </th>
                                                <th id="bankName">${sessionScope.languageJSON.currentPayTable.bankName}
                                                </th>
                                                <th id="accountType">
                                                    ${sessionScope.languageJSON.currentPayTable.accountType}</th>
                                                <th id="acctNbr">${sessionScope.languageJSON.currentPayTable.acctNbr}
                                                </th>
                                                <th id="depAmt" class="text-right">
                                                    ${sessionScope.languageJSON.currentPayTable.depAmt}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <c:forEach items="${accounts[frequency]}" var="account" varStatus="counter">
                                                <tr>
                                                    <td headers="bankCode"
                                                        data-title="${sessionScope.languageJSON.currentPayTable.bankCode}">
                                                        ${account.bankCd}
                                                    </td>
                                                    <td headers="bankName" class="text-left"
                                                        data-title="${sessionScope.languageJSON.currentPayTable.bankName}">
                                                        ${account.bankName}
                                                    </td>
                                                    <td headers="accountType" class="text-left"
                                                        data-title="${sessionScope.languageJSON.currentPayTable.accountType}">
                                                        ${account.bankAccountType} -
                                                        ${account.bankAccountTypeDescription}
                                                    </td>
                                                    <td headers="acctNbr" class="text-left"
                                                        data-title="${sessionScope.languageJSON.currentPayTable.acctNbr}">
                                                        ${account.bankAccountNumber}
                                                    </td>
                                                    <td headers="depAmt" class="text-right"
                                                        data-title="${sessionScope.languageJSON.currentPayTable.depAmt}">
                                                        <fmt:formatNumber value="${account.bankAccountAmount.amount}"
                                                            pattern="#,##0.00" />
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                ...
                                <c:if test="${fn:length(stipends[frequency]) > 0}">
                                    ...
                                    <table class="table border-table responsive-table print-table">
                                        <thead>
                                            <tr>
                                                <th id="extraDuty">
                                                    ${sessionScope.languageJSON.currentPayTable.extraDuty}</th>
                                                <th id="defaultAccountType" class="text-center">
                                                    ${sessionScope.languageJSON.currentPayTable.type}</th>
                                                <th id="extraDutyAmt" class="text-right">
                                                    ${sessionScope.languageJSON.currentPayTable.amount}</th>
                                                <th id="remainAmt" class="text-right">
                                                    ${sessionScope.languageJSON.currentPayTable.remainAmount}</th>
                                                <th id="remainPayments" class="text-right">
                                                    ${sessionScope.languageJSON.currentPayTable.remainPayments}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <c:forEach items="${stipends[frequency]}" var="stipend" varStatus="counter">
                                                <tr>
                                                    <td headers="extraDuty"
                                                        data-title="${sessionScope.languageJSON.currentPayTable.extraDuty}">
                                                        ${stipend.extraDutyDescription}
                                                    </td>
                                                    <td headers="defaultAccountType" class="text-center"
                                                        data-title="${sessionScope.languageJSON.currentPayTable.type}">
                                                        ${stipend.defaultAccountType}
                                                    </td>
                                                    <td headers="extraDutyAmt"
                                                        data-title="${sessionScope.languageJSON.currentPayTable.amount}">
                                                        <fmt:formatNumber value="${stipend.extraDutyAmt}"
                                                            pattern="#,##0.00" />
                                                    </td>
                                                    <td headers="remainAmt"
                                                        data-title="${sessionScope.languageJSON.currentPayTable.remainAmount}">
                                                        <fmt:formatNumber value="${stipend.remainAmt}"
                                                            pattern="#,##0.00" />
                                                    </td>
                                                    <td headers="remainPayments"
                                                        data-title="${sessionScope.languageJSON.currentPayTable.remainPayments}">
                                                        <fmt:formatNumber value="${stipend.remainPayments}"
                                                            pattern="#,##0.00" />
                                                    </td>
                                                </tr>
                                            </c:forEach>
