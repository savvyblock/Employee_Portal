    ...
    <ul class="navbar-nav nav-right">
      ...
      <li class="nav-item">
        <form action="/<%=request.getContextPath().split("/")[1]%>/logoutEA" method="post">
          <button class="nav-link nobtn-style" type="submit" role="button" aria-label="${sessionScope.languageJSON.accessHint.logout}" title="${sessionScope.languageJSON.accessHint.logout}">
