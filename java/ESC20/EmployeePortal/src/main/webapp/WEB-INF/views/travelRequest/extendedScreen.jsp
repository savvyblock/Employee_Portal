...
<body class="hold-transition sidebar-mini" onload="loadExtendedRows();">
	<div class="wrapper">
			...
			<section class="content">
				...
				<div class="content-white TRVL-detail heightFull">
					...
					<div class="content TRVL-detail heightFull">
							...
							<thead style="background-color: #2381A5; color:white;">
								<div class="row">
									<tr class="columnheader">
										<th style="width:5%"></th>
										<th id="dtAndTimeTrvl" style="width: 14%;">
											${sessionScope.languageJSON.mileageInfoTable.travelDatesAndTimes}
										</th>
										<th style="width: 13%;"></th>
										<th style="width: 22%;"></th>
										<th id="pntOrigin" style="width: 20%;">
											${sessionScope.languageJSON.mileageInfoTable.pointOfOrigin}</th>
										<th id="dest" style="width: 22%;">
							...
							<table class="table no-border-table">
								<thead style="background-color: #2381A5; color:white">
									<div class="row">
										<tr class="columnheader">
											<th style="width: 7%"></th>
											<th style="width: 12%;">${sessionScope.languageJSON.extendedMileageInfoTable.travelDetail}</th>
						...
						<input type="hidden" id="breakfastGreaterError"
							value="${sessionScope.languageJSON.validator.breakfastGreater}">
						<input type="hidden" id="lunchGreaterError"
							value="${sessionScope.languageJSON.validator.lunchGreater}">
						<input type="hidden" id="dinnerGreaterError"
							value="${sessionScope.languageJSON.validator.dinnerGreater}">
						<input type="hidden" id="overrideReasonEmptyError"
							value="${sessionScope.languageJSON.validator.overrideReasonEmpty}">
						...
						<input type="hidden" id="accomodationsEmptyError" 
							value="${sessionScope.languageJSON.validator.accomodationsEmpty}">
						<input type="hidden" id="directBillEmptyError" 
							value="${sessionScope.languageJSON.validator.directBillEmpty}">
						...
						<input type="hidden" id="lblAccommodations"
							value="${sessionScope.languageJSON.extendedMileageInfoTable.accommodations}">
						<input type="hidden" id="lblDirectBill"
							value="${sessionScope.languageJSON.extendedMileageInfoTable.directBill}">
						<input type="hidden" id="lblReimburesementAmt"
							value="${sessionScope.languageJSON.extendedMileageInfoTable.reimburesementAmt}">
						<input type="hidden" id="lblMeals"
							value="${sessionScope.languageJSON.extendedMileageInfoTable.meals}">
						<input type="hidden" id="lblMealOverride"
							value="${sessionScope.languageJSON.extendedMileageInfoTable.mealOverride}">
						<input type="hidden" id="lblMealsTotal"
							value="${sessionScope.languageJSON.extendedMileageInfoTable.mealTotal}">
						<input type="hidden" id="lblAdditionalExpenses"
							value="${sessionScope.languageJSON.extendedMileageInfoTable.additionalExpenses}">
						<input type="hidden" id="lblAdditionalExpenseTotal"
							value="${sessionScope.languageJSON.extendedMileageInfoTable.additionalExpenseTotal}">
						<input type="hidden" id="lblDailyTotal"
							value="${sessionScope.languageJSON.extendedMileageInfoTable.dailyTotal}">
