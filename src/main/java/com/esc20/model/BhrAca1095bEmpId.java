...
/**
 * BhrAca1095bEmpId generated by hbm2java
 */
@Embeddable
public class BhrAca1095bEmpId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4389022352479411540L;
	private String empNbr;
	private String calYr;

	public BhrAca1095bEmpId() {
	}

	public BhrAca1095bEmpId(String empNbr, String calYr) {
		this.empNbr = empNbr;
		this.calYr = calYr;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrAca1095bEmpId))
			return false;
		BhrAca1095bEmpId castOther = (BhrAca1095bEmpId) other;
