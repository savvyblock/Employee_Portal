...
/**
 * BhrPmisPosDistrRollbkId generated by hbm2java
 */
@Embeddable
public class BhrPmisPosDistrRollbkId implements java.io.Serializable {
	...
	public BhrPmisPosDistrRollbkId() {
	}

	public BhrPmisPosDistrRollbkId(char cyrNyrFlg, char befOrAft, char payFreq, String occEmpNbr, String dtsCipTrans,
			String posNbr, String billetNbr, char posTyp, short distrSeq) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrPmisPosDistrRollbkId))
			return false;
		BhrPmisPosDistrRollbkId castOther = (BhrPmisPosDistrRollbkId) other;
