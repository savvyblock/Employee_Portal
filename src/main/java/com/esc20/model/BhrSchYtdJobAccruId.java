...
/**
 * BhrSchYtdJobAccruId generated by hbm2java
 */
@Embeddable
public class BhrSchYtdJobAccruId implements java.io.Serializable {
	...
	public BhrSchYtdJobAccruId() {
	}

	public BhrSchYtdJobAccruId(char payFreq, String empNbr, char cyrNyrFlg, String schYr, String jobCd) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrSchYtdJobAccruId))
			return false;
		BhrSchYtdJobAccruId castOther = (BhrSchYtdJobAccruId) other;
