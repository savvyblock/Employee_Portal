...
/**
 * BthrSimHrlyDlySalId generated by hbm2java
 */
@Embeddable
public class BthrSimHrlyDlySalId implements java.io.Serializable {
	...
	public BthrSimHrlyDlySalId() {
	}

	public BthrSimHrlyDlySalId(char cyrNyrFlg, String simName, String payGrd, String payStp, char sched) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BthrSimHrlyDlySalId))
			return false;
		BthrSimHrlyDlySalId castOther = (BthrSimHrlyDlySalId) other;
