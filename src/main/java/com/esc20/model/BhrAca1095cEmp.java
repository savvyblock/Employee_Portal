...
/**
 * BhrAca1095cEmp generated by hbm2java
 */
@Entity
@Table(name = "BHR_ACA_1095C_EMP", schema = "rsccc", catalog = "rsccc")
public class BhrAca1095cEmp implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4563173785218272688L;
	private BhrAca1095cEmpId id;
	...
	public BhrAca1095cEmp() {
	}

	public BhrAca1095cEmp(BhrAca1095cEmpId id, String offrOfCovrg, BigDecimal empShr, String safeHrbr, char selfIns,
			String module, String planStrtMon) {
		this.id = id;
	...
	public BhrAca1095cEmpId getId() {
		return this.id;
	}

	public void setId(BhrAca1095cEmpId id) {
		this.id = id;
	}
