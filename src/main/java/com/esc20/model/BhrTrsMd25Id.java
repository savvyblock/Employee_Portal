...
/**
 * BhrTrsMd25Id generated by hbm2java
 */
@Embeddable
public class BhrTrsMd25Id implements java.io.Serializable {
	...
	public BhrTrsMd25Id(String rptMon, String rptYr, String staffId) {
		this.rptMon = rptMon;
		this.rptYr = rptYr;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrTrsMd25Id))
			return false;
		BhrTrsMd25Id castOther = (BhrTrsMd25Id) other;
