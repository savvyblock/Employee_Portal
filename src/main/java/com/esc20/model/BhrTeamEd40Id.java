...
/**
 * BhrTeamEd40Id generated by hbm2java
 */
@Embeddable
public class BhrTeamEd40Id implements java.io.Serializable {
	...
	public BhrTeamEd40Id() {
	}

	public BhrTeamEd40Id(String rptYr, String rptMon, String empNbr, String trsPosCd) {
		this.rptYr = rptYr;
		this.rptMon = rptMon;
		this.empNbr = empNbr;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BhrTeamEd40Id))
			return false;
		BhrTeamEd40Id castOther = (BhrTeamEd40Id) other;
